...
class LattesRobot:
    ...
    def create_driver(self):
        ...
        chrome_binary = os.environ.get('SCRIPTLATTES_CHROME_BINARY')
        if chrome_binary:
            chrome_options.binary_location = chrome_binary

        chrome_driver_path = os.environ.get('SCRIPTLATTES_CHROMEDRIVER_PATH')
...
def __get_data(id_lattes, diretorio):
    driver_path = os.environ.get('SCRIPTLATTES_CHROMEDRIVER_PATH', './chromedriver')
    rob = LattesRobot(driver_path=driver_path, results_dir=diretorio)
